						...
						<div class="moneyTable feeTable" style="width:668px;">
							<table width="100%">
								<tr>
									...
									<td class="center" width='10%'>Last spending amount</td>
									<td class="center" width='5%'>Last time consumption</td>									
									<td class="center" width='5%'>Last order</td>
								...
								<!--
									...
									<?php if ($state=='0'){?><a href="userorder_subscribe_do.php?id=<?php echo $rows['order_id']?>&act=sure&ao=<?php echo $ao?>"><br/>订单确认</a><?php }?> <?php if ($state=='1'){?><a href="userorder_subscribe_do.php?id=<?php echo $rows['order_id']?>&act=bc&totalprice=<?php echo $rows['order_totalprice']?>&key=<?php echo $key?><?php echo $url?>">Order</a><?php }?>
